...
(function($, undefined) {
    $.widget("mobile.simpledialog", $.mobile.widget, {
        ...
        open: function() {
            ...
            if (!o.disabled) {
                if ((docWinWidth > 320 && !o.useDialogForceTrue) || o.useDialogForceFalse || o.fullScreen) {
                    o.useDialog = false;
                    ...
                    if (o.fullScreenAlways || (o.fullScreen && docWinWidth < 320)) {
        ...
        _buildPage: function() {
			...
			.bind(o.clickEvent, function(event) {
			    if (!o.forceInput) {
			        //self.close(); [Ankur commented on 15/02/2012]			        
			    }
